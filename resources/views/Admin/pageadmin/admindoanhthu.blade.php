                                        ...
                                        <div class="card">
                                            <div class="header">
                                                ...
                                                <script>
                                                        ...
                                                        $('#spdh').val('Số lượng sản phẩm bán ra năm ' + n);
                                                </script>
                                            <div class="content">
                                                ...
                                                <script>
                                                    new Chart(document.getElementById("line-chart"), {
                                                        ...
                                                        , options: {
                                                            title: {
                                                                display: true
                                                                , text: 'Thống kê số lượng sản phẩm bán ra theo tháng'
                                                                , fontSize: 20
                                                            }
                                                        }
                                                    });
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card ">
                                            <div class="header">
                                                <h4 class="title">
                                                    <input id="dh" type="text" style="width: 100%; border: none; background: none" disabled>
                                                </h4> 
                                                <script>
                                                        var d = new Date();
                                                        var n = d.getUTCFullYear();
                                                        $('#dh').val('Thống kê đơn hàng năm ' + n);
                                                </script>
                                            </div>
                                            <div class="content">
                                                ...
                                                <script>
                                                    new Chart(document.getElementById("mixed-chart"), {
                                                        ...
                                                        options: {
                                                          title: {
                                                            display: true,
                                                            text: 'Thống kê về đơn hàng theo tháng',
                                                            fontSize: 20,
                                                          },
