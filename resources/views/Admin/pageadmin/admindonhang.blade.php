                            ...
                            <div class="container-fluid">
                                <table class="table table-bordered text-align" id="myTable">
                                    ...
                                    <tr class="choxacnhan">
                                        ...
                                        <td><a href="" data-toggle="modal" data-target="#b_{{$cb->id}}">Xem</a>
                                        </td>
                                        <td><a href="" data-toggle="modal" data-target="#c_{{$cb->id}}">Xem</a>
                                        </td>
                                        <td>
                            ...
                            <div class="container-fluid">
                                <table class="table table-bordered text-align" id="myTable">
                                    ...
                                    <tr class="danggui">
                                        ...
                                        <td><a href="" data-toggle="modal" data-target="#b_{{$sb->id}}">Xem</a>
                                        </td>
                                        <td><a href="" data-toggle="modal" data-target="#c_{{$sb->id}}">Xem</a>
                                        </td>
                                        <td>
                            ...
                            <div class="container-fluid">
                                <table class="table table-bordered text-align" id="myTable">
                                    ...
                                    @endif
                                        ...
                                        <td><a href="" data-toggle="modal" data-target="#b_{{$ob->id}}">Xem</a>
                                        </td>
                                        <td><a href="" data-toggle="modal" data-target="#c_{{$ob->id}}">Xem</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
...
@foreach($bills as $b)
    ...
    <div class="modal fade modalcart" id="c_{{$b->id}}">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Khách hàng {{$c->name}} đã mua <a href="" data-toggle="modal" data-target="#b_{{$b->id}}"><u>đơn hàng {{$b->id}}</u></a></h4>
                </div>
                <!-- Modal body -->
                <div class="modal-body cart-center clearfix">
                ...
                <div class="modal-footer">
                    ...
                    @if($b->status == 4)
                        <button class="btn btn-danger" id="mccancle_{{ $b->id }}" type="button">Huỷ đơn hàng</button>
                        <button class="btn btn-primary" id="mccheck_{{ $b->id }}" type="button">Duyệt đơn hàng</button>
                    @elseif($b->status == 3)
                        <button class="btn btn-danger" id="mcf_{{ $b->id }}" type="button">Thất bại</button>
                        <button class="btn btn-primary" id="mcs_{{ $b->id }}" type="button">Thành công</button>
                    @endif
                </div>
                <script>
                    $('#mccheck_{{ $b->id }}').on('click', function(){
                        var checkid = "{{ $b->id }}";
                        $.ajax({
                            type: "GET",
                            url: "check-bill",
                    ...
                    $('#mccancle_{{ $b->id }}').on('click', function(){
                        var cancleid = "{{ $b->id }}";
                        $.ajax({
                            type: "GET",
                            url: "cancle-bill",
    ...
    @if($gb->bid == $b->id)
    <div class="modal fade modalcart" id="b_{{$b->id}}">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Đơn hàng {{$b->id}} (có {{$b->total_product}} sản phẩm) </h4>
                </div>
                <!-- Modal body -->
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                    @if($b->status == 4)
                        <button class="btn btn-danger" id="mbcancle_{{ $b->id }}" type="button">Huỷ đơn hàng</button>
                        <button class="btn btn-primary" id="mbcheck_{{ $b->id }}" type="button">Duyệt đơn hàng</button>
                    @elseif($b->status == 3)
                        <button class="btn btn-danger" id="mbf_{{ $b->id }}" type="button">Thất bại</button>
                        <button class="btn btn-primary" id="mbs_{{ $b->id }}" type="button">Thành công</button>
                    @endif
                </div>
                <script>
                    $('#mbcheck_{{ $b->id }}').on('click', function(){
                        var checkid = "{{ $b->id }}";
                        $.ajax({
                            type: "GET",
                            url: "check-bill",
                    ...
                    $('#mbcancle_{{ $b->id }}').on('click', function(){
                        var cancleid = "{{ $b->id }}";
                        $.ajax({
                            type: "GET",
                            url: "cancle-bill",
