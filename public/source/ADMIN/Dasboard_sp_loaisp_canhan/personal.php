                            ...
                            <div class="panel-body">
                                <form method="post" action="edit_account.php?id=1" class="clearfix">
                                    <div class="form-group">
                                        ...
                                        <input type="name" class="form-control" name="name" placeholder="Tên đăng nhập">
                                    </div>
                                    <div class="form-group">
                                        <label for="username" class="control-label">Mật khẩu</label>
                                        <input type="password" class="form-control" name="username" placeholder="Mật khẩu">
                                    </div>
                                    <div class="form-group clearfix">
                                        <button type="submit" name="updatepwd" class="btn btn-danger pull-right css_changepass">Đổi mật khẩu</button>
                                    </div>
                                </form>
                            </div>
                        </div>
