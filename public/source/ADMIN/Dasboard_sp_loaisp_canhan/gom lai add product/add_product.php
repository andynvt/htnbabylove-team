...
<!--    <link href='trangchu/css/slideshow.css' rel='stylesheet' type='text/css'> -->
    <link href='kn_css/add_product.css' rel='stylesheet' type='text/css'> 
...
<!--                                    <h2>Thêm Sản Phẩm</h2>-->
                                    <form class="form-horizontal" action="/action_page.php" enctype="multipart/form-data" id="formUpload" onsubmit="return false;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control w50" id="ma" placeholder="Nhập mã" name="ma">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="maloai">Mã Loại:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control w50" id="maloai" placeholder="Nhập mã loại" name="maloai">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="ten">Tên:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control w50" id="ten" placeholder="Nhập tên" name="ten">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="giagoc">Giá gốc:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control w50" id="giagoc" placeholder="Nhập giá gốc" name="giagoc">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="magiamgia">Mã giảm giá:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control w50" id="magiamgia" placeholder="Nhập mã giảm giá" name="magiamgia">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <button type="button" onclick="myFunction2()">Xóa tiệp ảnh cuối</button><br>
                                                    <div class="inputadd">
                                                        <div class="show">
...
-->
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-6 col-sm-8">
                                                ...
                                                <button type="submit" class="btn btn-light btn-magrin2">Hủy</button>
