                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="content">
                                    <div class="div-charts-admin">
                                        <canvas id="buyers" width="600px" height="400px"></canvas>
                                    </div>
                                    <div class="footer">
            ...
            <script>
                ...
                var buyerData = {
                    ...
                    datasets: [{
                        ...
                        data: [203, 156, 99, 251, 305, 247, 266, 457, 779, 988, 666, 251]
                    }],
                }
                ...
                function cc() {
                    $("#countries").attr("width", "600px !important");
                }


                //                AmCharts.makeChart(".div-charts-admin", {
                //                    ...,
                //                    "responsive": {
                //                        "enabled": true
                //                    }
